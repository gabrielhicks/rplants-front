                    ...
                    <Page>
                        <TopDetails>
                            <Photo
                                ...
                                onClick={this.imageFlipHandler}
                                src={
                                    this.state.clicked
                                        ? this.props.plant.image2
                                        : this.props.plant.image
                                }></Photo>
                            <Details>
                                <PlantHeading>
                                ...
                                <SubHeading>
                                    {this.props.plant.scientific}
                                </SubHeading>

                                {this.props.plant.pet_friendly ? (
                                    <PetFriendly>
                                        <img
                                            alt='plant friendliness'
                                            src='https://i.ibb.co/QkX6rPD/paw.webp'
                                        />
                                        &nbsp;&nbsp;Pet-friendly!
                                    </PetFriendly>
                                ) : null}
                        ...
                        {this.state.careInstructions ? (
                            <Heading onClick={this.showCareInstructions}>
                                Care Instructions
                                <img
                                    class='after'
                                    alt='plant'
                                    src='https://i.ibb.co/LgQ2LHK/icon.webp'
                                />
                            </Heading>
                        ) : (
                            <Heading onClick={this.showCareInstructions}>
                                ...
                                <img
                                    class='before'
                                    alt='pot'
                                    src='https://i.ibb.co/CwYYwH8/pot.webp'
                                />
                            </Heading>
                        )}
                        <BottomDetails>
