...
export class CartItem extends Component {
    ...
    localDeleteHandler = () => {
        this.props.deleteHandler(
            this.props.plant.id,
            this.props.plant.size,
            this.props.plant.quantity
        );
    };
        ...
        return (
            <CartCard>
                ...
                <CartText>
                    ...
                    <Size>
                        Size:{' '}
                        {this.props.plant.size[0].toUpperCase() +
                            this.props.plant.size.slice(1)}
                    </Size>
                    <Quantity>Quantity: {this.props.plant.quantity}</Quantity>
                    <Price>
                        Price: $
                        {this.props.plant.price[this.props.plant.size] *
                            this.props.plant.quantity}
                    </Price>
